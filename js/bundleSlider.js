...
//модалка для слайдера
const widthWindow = window.innerWidth; //972 Заменить везде на переменную???
...
let slider = document.querySelector('.slider'),
  ...
  slideWidth = window.innerWidth, //myWidth.slice(0, myWidth.length-2),//ТУТ
  slideIndex = 0,
  posInit = 0,
  posX1 = 0,
  posX2 = 0,
  ...
  lastTrf = lengthSlides * slideWidth,//ТУТ
  posThreshold = slideWidth * 0.35,//ТУТ
  trfRegExp = /([-0-9.]+(?=px))/;
...
/******/ })()
;
//# sourceMappingURL=bundleSlider.js.map